...
class FrameLbl(object):
    ...
    **kwargs : specific args for segmentation function
    ...
    """
    def __init__(self, frame=None, MD=None ,pth=None, Pos=None, acq = None, Zindex=0 ,register=True ,periring=False, periringsize=5, NucChannel='DeepBlue',cytoplasm=False,CytoChannel=None,zernike=False, segment_type='watershed', **kwargs):
        ...
        NucChannel = NucChannel if isinstance(NucChannel, list) else [NucChannel]
        CytoChannel = CytoChannel if isinstance(CytoChannel, list) else [CytoChannel]
        ...
        input_dict = {**input_dict, **kwargs, 'nucchannel': NucChannel, 'cytochannel': CytoChannel}
